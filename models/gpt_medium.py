...
def generate_response(question, context):
    """
    Generate a response using GPT-2 Medium based on the provided question and context.
    """
...
def ask_gpt2(question, context):
    """
    Generate an answer to a question based on the provided context using GPT-2 Medium.
    """
    try:
        # Find the best matching chunk for the question
        best_chunk = find_best_chunk(question, context)
        
        # Generate a response based on the best chunk
...
def ask_gpt2_from_pdf(project_name, pdf_filename, question):
    """
    Extract text from the PDF located in a specific project folder, chunk it, and generate a response using GPT-2 Medium.
